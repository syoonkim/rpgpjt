...
public class Skill11 implements Skill {

	@Override
	public void skill(Poke sub, Poke obj) {
		System.out.println("["+sub.getName()+"의 하이드로펌프 공격.]");
		...
		boolean x2=false;
		boolean x12=false;
		if(obj.getType().equals("물") || obj.getType().equals("풀") || 
		   obj.getType().equals("드래곤")) x12=true;
		
		if(obj.getType().equals("불") || obj.getType().equals("땅") || 
